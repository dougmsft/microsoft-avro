...
namespace Microsoft.Hadoop.Avro.Utils.Templates
{
    ...
    internal partial class EnumTemplate : EnumTemplateBase
    {
        ...
        public virtual string TransformText()
        {
            ...
            this.Write("\r\n{\r\n    using System.Runtime.Serialization;\r\n\r\n    /// <summary>\r\n    /// Used t" +
                    "o serialize and deserialize Avro enum ");
    ...
    foreach(var symbol in ((EnumSchema)this.Schema).Symbols)
    {

            this.Write("        /// <summary>\r\n        /// The ");
            this.Write(this.ToStringHelper.ToStringWithCulture(Utilities.Validate(symbol)));
            this.Write(" symbol.\r\n        /// </summary>\r\n        [EnumMember]\r\n        ");
            this.Write(this.ToStringHelper.ToStringWithCulture(Utilities.Validate(symbol)));
            this.Write(",\r\n\r\n");
